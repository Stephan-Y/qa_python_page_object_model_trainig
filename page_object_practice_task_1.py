...
class TestPraktikum:
    ...
    def test_get_description(self):
        ...
        # Авторизацию
        login_page.login('Stepan-Y@ya.ru','123')
        ...
        # сохраняю в переменную description текстовое значение поля «Занятие»
        description = home_page.get_description()

        # проверяю через assert, что полученное текстовое значение поля «Занятие» совпадает с ожидаемым
